      ...
      <ScreenContainer containerClassName="bg-background" safeAreaClassName="">
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptySubtitle}>
            Generate a story and tap the heart to save it here.
          </Text>
          <Pressable
            style={({ pressed }) => [
              styles.createBtn,
          ...
          >
            <View style={styles.cardLeft}>
              <Text style={styles.cardEmoji}>
                {CHARACTER_EMOJIS[item.config.characterType] || "📖"}
              </Text>
            </View>
            <View style={styles.cardContent}>
              ...
              <Text style={styles.cardMeta}>
                {STYLE_EMOJIS[item.config.style] || "✨"} {item.config.style} •{" "}
                {item.config.scenario} • {item.config.lengthMinutes} min
              </Text>
            ...
            >
              <IconSymbol name="trash.fill" size={16} color="#4A4270" />
            </Pressable>
          </Pressable>
        )}
      />
